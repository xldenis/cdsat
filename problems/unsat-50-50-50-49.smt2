...
(assert (= (or (and (= x17 (or x26 x13)) (< y0 92)) true) (or x27 (or false x19))))
(assert (and (and true (or (< y15 y32) x36)) (or true true)))
(assert (or false (or x4 x31)))
(assert (and (= 54 (+ y7 y21)) x29))
(assert (or (or (or false x13) (< y10 y20)) (and (< 88 y6) false)))
(assert (or (and x35 (or true x25)) (= false true)))
(assert (and (= 4 6) true))
(assert (= 18 (+ y1 y32)))
(assert (or x25 x28))
(check-sat)
