...
(assert (= (= x45 x38) (and false x16)))
(assert (and (or (= x27 x4) (or x6 true)) (= (or true x2) false)))
(assert (or false x6))
(assert (and (or false (= false false)) (and true false)))
(assert (and (= (= x0 true) (and x28 true)) true))
(assert (and x42 (or (= (= x3 x43) x48) (= x32 x39))))
(assert (= (= (= false true) false) x21))
(assert (= (= (and (and (and (= false x33) (and true x33)) true) true) (= (and (and false true) (or (and x32 x33) x15)) (or (and x27 (or true true)) true))) (= (and false (and x48 true)) (or (and true false) (or x3 x34)))))
(assert (and (and x20 x4) (or (or (and (= false x14) (or false false)) (or (or x48 x23) true)) (and false (and (or true x13) true)))))
(assert (= x7 (= x17 x14)))
(check-sat)
