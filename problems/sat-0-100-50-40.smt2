...
(assert (or (and (or x27 true) (or x42 false)) x38))
(assert (= (= x58 x56) false))
(assert (= x47 false))
(assert (or x67 (= (= true x84) (and true false))))
(assert (= (= (and x21 (= x60 x79)) (or x87 x80)) (and (or true x18) (= x14 x2))))
(assert (= (or (= x36 (and (and true false) x30)) (= x58 false)) (or x87 x31)))
(assert (and (or x83 x75) (= false false)))
(check-sat)
