...
(assert (and (or (and false (or x53 x38)) (= true true)) (and (= x66 true) x10)))
(assert x50)
(assert (and (= (and x18 (or x73 (= x20 x60))) false) (= (or (= x21 true) true) (= x22 (or x49 x7)))))
(assert (= x40 x31))
(assert (or (and x57 x76) (or x70 (or x60 x8))))
(assert (or (or (and x18 x53) (or x41 true)) (or x53 (or x9 x29))))
(assert (and x42 (or x76 x25)))
(assert (or (and (= true false) (= (= (= true true) (and true true)) (= x59 x28))) (= true (or (and true true) (= true (and x41 false))))))
(check-sat)
