...
(assert (= true (or true x25)))
(assert (= 21 y10))
(assert (< 26 14))
(assert (< 52 (+ (+ 11 y13) y8)))
(assert (or (= x15 false) (< y3 96)))
(assert (= 11 8))
(assert (or (or (< (+ y28 y28) 65) (or (and x6 x16) x0)) (and (= y19 75) x20)))
(assert (or (and x9 x16) (< y24 57)))
(assert (and (= (< y1 (+ 28 y12)) (= y30 (+ 86 94))) (and (and true true) (< y25 y26))))
(check-sat)
