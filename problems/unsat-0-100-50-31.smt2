...
(assert (= (= (or false (and x39 x50)) (or (and x25 (or x1 x2)) true)) (and (= x36 true) (and (and true x47) true))))
(assert (or (= (= (or true false) (or (or (or (and true true) true) (and false (or true x42))) (= x7 true))) (= (= false (and x36 false)) x49)) (or (and true false) x9)))
(assert (= false (= true x9)))
(assert x17)
(assert (= (= x49 x29) (and (and true x37) (or false true))))
(assert (or (and (and (or x3 false) x7) (or (and false false) (or x26 x29))) (and true (or x35 true))))
(assert x2)
(assert (= (= x7 x7) false))
(assert (and (or (= (and x47 x20) true) (and true x0)) (or (= false x6) (and (= (or true x32) true) (= x44 false)))))
(assert true)
(check-sat)
