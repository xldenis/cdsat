...
(assert (and x70 true))
(assert (= x15 (or x88 x54)))
(assert (or (= true true) (= x88 (or true true))))
(assert (and true x33))
(assert (and (and false x39) true))
(assert (= false x15))
(assert (and (or true x23) (and (or x33 false) x8)))
(assert (= true (= x52 x77)))
(assert (= (= (or false false) (= true true)) x38))
(assert (or (or (or (= x4 false) (or true true)) (and true true)) x32))
(check-sat)
