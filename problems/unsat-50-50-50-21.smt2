...
(assert (= (or (= y4 y20) (= y26 29)) (and x12 true)))
(assert (< 20 y17))
(assert (= 32 y6))
(assert (< 29 84))
(assert (and (or (or true x39) false) (= (< (+ y6 y7) (+ 74 82)) (and x38 x25))))
(assert (= (+ 83 74) 27))
(assert (or (or x27 (< y9 y2)) (or true (< 89 (+ y5 25)))))
(assert (and (or x7 true) (< 39 y7)))
(assert (and (= (and (< 11 57) (< 42 y10)) false) (or (and x24 (or x26 true)) (= false x32))))
(assert (< y17 y14))
(check-sat)
