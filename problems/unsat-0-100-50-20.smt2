...
(assert (or x52 x24))
(assert (or (and (or (or true x23) (or (and x22 x45) x45)) (= (and x6 false) x62)) (or (or (= true x70) x79) (= false (or (= x79 x2) false)))))
(assert (= (or (or false x29) (= x50 (or false x45))) (and x67 (or x17 x34))))
(assert (= (= false (or x19 x25)) (= x79 (and x41 false))))
(assert (and (= (or false x14) (= false true)) (= (and (or true x62) (and x17 x12)) (= false x23))))
(assert (= (or (and true true) (= true false)) (= (and (and (or true x25) (= true true)) x63) false)))
(assert (and (= x17 (and (= false false) (and true x57))) true))
(assert (or (or (= false true) (= true x9)) (and false (and x30 x4))))
(assert (or (= true x74) (or false x73)))
(check-sat)
