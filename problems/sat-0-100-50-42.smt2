...
(assert (and (and (and true (or x4 (= x36 x84))) (= x7 false)) (= (and (and false x50) true) (= (= false false) (or false x40)))))
(assert (or (or (and x44 true) (= true false)) (= (or (or true x79) (and false (= x20 x82))) (and x48 (and false true)))))
(assert x0)
(assert (or (= (and x46 true) (or (or true x56) false)) (and x63 x15)))
(assert (or (or false true) x70))
(assert (or (and (or (= (= x24 true) x35) (and (and x64 true) x77)) (or (= true (and true false)) x67)) (and (and false x81) x58)))
(assert (or (= x2 false) (= false false)))
(assert (and (= true x75) true))
(assert (or x73 x74))
(assert (= (and x67 x47) (and x77 true)))
(check-sat)
