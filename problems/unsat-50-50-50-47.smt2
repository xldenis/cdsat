...
(assert (< 89 50))
(assert (or false (= (or false true) (and (and x16 x14) (or x6 false)))))
(assert (= (+ 93 (+ 60 11)) 57))
(assert (and true x19))
(assert (or true x3))
(assert (or (= true x15) (= x14 (= 44 6))))
(assert (and (or x22 false) (and false x19)))
(assert (and (= y23 50) true))
(assert (< 89 99))
(assert (and (and x0 true) (= y14 20)))
(check-sat)
