...
(assert x34)
(assert (and false x25))
(assert (and (= (+ y23 24) 21) (= false (or true (< y13 (+ 17 y11))))))
(assert x19)
(assert (= (+ 36 51) y24))
(assert (< 57 (+ (+ 99 y17) y20)))
(assert (< y5 95))
(assert (or (and x1 x36) (= y22 72)))
(assert true)
(assert (and false (= false (or true (and x9 x36)))))
(check-sat)
