...
(assert (< (+ 0 1) y2))
(assert (and (and (= false true) (< 54 48)) (or (< y9 64) x10)))
(assert (and (and (< 36 y26) x5) (= (or x1 false) (or x2 x10))))
(assert (and (or false x9) x4))
(assert (< (+ 80 y11) y27))
(assert (and (< y13 61) true))
(assert (and (= y28 y25) (< y13 y24)))
(assert (< (+ y25 11) 65))
(assert x9)
(assert (and (and x10 x10) (= (or true (< 93 y23)) (< 10 y27))))
(check-sat)
